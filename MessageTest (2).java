...
public class MessageTest {
    ...
    // -------------------------------------------------------
    // POE test data — exact strings from the POE document
    // -------------------------------------------------------
    ...
    // -------------------------------------------------------
    // @BeforeEach — clears arrays and populates with POE data
    // -------------------------------------------------------
    @BeforeEach
    public void setUp() {
    ...
    // =======================================================
    // PART 3 TESTS — Six new tests using exact POE data
    // =======================================================

    /**
     * Test 1: sentMessages array correctly populated.
     * Messages 1 and 4 are flagged as Sent.
     * POE expected: contains "Did you get the cake?" and "It is dinner time!"
     */
    @Test
     ...
     * POE expected: "It is dinner time!"
     */
    @Test
